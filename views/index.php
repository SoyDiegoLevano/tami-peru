...
<head>
    ...
    <link rel="preload" fetchpriority="high" as="image" href="../public/images/PORATADA.webp" type="image/webp">
    ...
    <main class="main__inicio">
        ...
        <section class="productos" id="productos">
            <figure class="productos__img">
                <img loading="lazy" class="vid__item" src="../public/images/catalogo_productos/SOLDADORASPARK1.webp" alt="">
                <p class="nombre_producto">Trabajo</p>
            </figure>
            <figure class="productos__img">
                <img loading="lazy" class="vid__item" src="../public/images/catalogo_productos/BAMBOOFIBERWALLBOARD1.webp" alt="">
                <p class="nombre_producto">Decoración y hogar</p>
            </figure>
            <figure class="productos__img">
                <img loading="lazy" class="vid__item" src="../public/images/catalogo_productos/SELLADORDEVASOS1.webp" alt="">
