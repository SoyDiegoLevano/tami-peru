...
<title>WPC Wall Panel | TAMI</title>
        ...
        <div class="product-details">
            <div class="product-images">
                <div class="image-container">
                    <img class="principal-img" src="../public/images/catalogo_productos/WPCWALLPANEL.webp" />
                    <video class="principal-img" src="../public/videos/WPCWall.mp4" style="display:none" controls></video>
                </div>
                <div class="product-thumbnails">
                    <img src="../public/images/catalogo_productos/WPCWALLPANEL.webp" alt="Thumbnail 1" onclick="changeMedia(this)"/>
                    <img src="../public/images/catalogo_productos/WPCWall/1WPCWall.webp" alt="Thumbnail 2" onclick="changeMedia(this)"/>
                    <img src="../public/images/catalogo_productos/WPCWall/2WPCWall.webp" alt="Thumbnail 3" onclick="changeMedia(this)"/>
                    <img src="../public/images/catalogo_productos/WPCWall/4WPCWall.webp" alt="Thumbnail 4" onclick="changeMedia(this)"/>
                    <video src="../public/videos/WPCWall.mp4" alt="Thumbnail 5" onclick="changeMedia(this)"></video>
                ...
                <div class="detalles">
                    ...
                    <div class="detalles-subcont">
                        <div class="detalles-extra">
                            <b>Paquete:</b> 10 pcs/ctn <br>
                            <b>Longitud:</b> 2,9 metros o personalizado <br>
