...
<title>WPC Fence Panel | TAMI</title>
...
<main class="p_individual">
    <div class="modal-content">
        <div class="product-details">
            <div class="product-images">
                <div class="image-container">
                    <img class="principal-img" src="../public/images/catalogo_productos/WPCFENCEPANEL.webp" />
                    <video class="principal-img" src="../public/videos/WPCFencel.mp4" style="display:none" controls></video>
                </div>
                <div class="product-thumbnails">
                    <img src="../public/images/catalogo_productos/WPCFENCEPANEL.webp" alt="Thumbnail 1" onclick="changeMedia(this)"/>
                    <img src="../public/images/catalogo_productos/WPCFencel/1WPCFencel.webp" alt="Thumbnail 2" onclick="changeMedia(this)"/>
                    <img src="../public/images/catalogo_productos/WPCFencel/2WPCFencel.webp" alt="Thumbnail 3" onclick="changeMedia(this)"/>
                    <img src="../public/images/catalogo_productos/WPCFencel/4WPCFencel.webp" alt="Thumbnail 4" onclick="changeMedia(this)"/>
                    <video src="../public/videos/WPCFencel.mp4" alt="Thumbnail 5" onclick="changeMedia(this)"></video>
            ...
            <div class="product-info">
                ...
                <div class="detalles">
                    <div class="detalles-subcont">
                        ...
                        <br>
                        <span>La Tecnología WPC es ideal para la decoración de interiores ya que cuenta con la resistencia al fuego y agua, además de que se limpia fácil, existen una amplia variedad de combinaciones en colores y estilos.</span>
                    </div>
                    <div class="detalles-subcont">
                        <div class="detalles-extra">
                            <b>Tipo:</b> Panel de cerca <br>
                            <b>Característica:</b> Anti-UV, impermeable, anti-decoloración, etc. <br>
                            <b>Aplicación:</b> Hotel, hogar, apartamento, etc. <br>
                            <b>Resistente al:</b> Agua, fuego, polvo <br>
                            <b>Tipo de decoración:</b> Exteriores <br>
                        </div>
                    </div>
                    <div class="detalles-subcont">
                    ...
                    <div class="detalles-subcont">
                        ...
                        <button id="submitButton_WPC__FENCEPANEL" class="button" style="display: none;">FINALIZAR</button>
                    </div>
                </div>
        ...
        <div style="width: 100%; color: #7B7C89;">
            <div id="notification_WPC__FENCEPANEL" style="display: none;" class="notification">
                <p id="notification-text_WPC__FENCEPANEL"></p>
...
function generarModalForm() {
    ...
    //                    const notification = document.getElementById(`notification_WPC__FENCEPANEL`);
    //                    const notificationText = document.getElementById(`notification-text_WPC__FENCEPANEL`);
    ...
    //                }
                    ...
                    document.getElementById(`submitButton_WPC__FENCEPANEL`).addEventListener('click', () => mostrarNotificacion());
}
function mostrarNotificacion() {
                        const notification = document.getElementById(`notification_WPC__FENCEPANEL`);
                        const notificationText = document.getElementById(`notification-text_WPC__FENCEPANEL`);
...
function enviarButton() {
    ...
    var msg1 = "¿Quieres remodelar tu hogar? Transforma tu espacio al aire libre en un oasis de"+
            "elegancia y durabilidad con nuestro WPC Fence Panel. Con la belleza atemporal de"+
            "la madera de ingeniería y la resistencia del WPC, crea un ambiente donde cada"+
            "momento al aire libre se convierta en una experiencia memorable. ¡Haz de tu patio"+
            "un lugar para relajarte y disfrutar con estilo!🌿🏡✨";
    var cierre1 = "🤔 Preguntas o Consultas: \n"+
            "¡Descubre el poder de la remodelación con WPC Fence Panel! \n"+
            ...
            "https://www.tami-peru.com/views/wpcfencepanel.php \n"+
            "Gracias por tu preferencia 🤗";
    var msg2 = "✨¿Te gustaría remodelar tu patio con estética y elegancia? Descubre la revolución "+
            "en cercas con nuestro WPC Fence Panel 🌟🏡. Este concepto de valla estético e "+
            "innovador fusiona un poste de ángulo variable con una tira de aluminio recubierta en "+
            "polvo. 🛡️✨ Añade estilo y durabilidad a tus espacios exteriores. Más detalles en el "+
            "flyer adjunto 👀📄.";
    var cierre2 ="🤔 Preguntas o Consultas: \n"+
            "¡No pierdas la oportunidad de adquirir tu WPC FENCE PANEL! \n"+
            "Recibe tu asesoría gratis y un descuento exclusivo en las primeras 24h🌟\n"+
            "Para más información sobre el producto, ingrese a nuestra página web  👇👇👇 \n"+
            "https://www.tami-peru.com/views/wpcfencepanel.php \n"+
            "Gracias por tu preferencia 🤗";
