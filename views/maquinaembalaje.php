...
<head>
    ...
    <title>Maquina de Embalaje | TAMI</title>
...
<body>
    ...
    <main class="p_individual">
        <div class="modal-content">
            <div class="product-details">
                <div class="product-images">
                    <div class="image-container">
                        <img class="principal-img" src="../public/images/catalogo_productos/MÁQUINADEEMBALAJE.webp" />
                        <video class="principal-img" src="../public/videos/MÁQUINADEEMBALAJE.mp4" style="display:none" controls></video>
                    </div>
                    <div class="product-thumbnails">
                        <img src="../public/images/catalogo_productos/MÁQUINADEEMBALAJE.webp" alt="Thumbnail 1" onclick="changeMedia(this)" />
                        <img src="../public/images/catalogo_productos/MaquinaEmbalaje/1_MÁQUINADEEMBALAJE.webp" alt="Thumbnail 2" onclick="changeMedia(this)" />
                        <img src="../public/images/catalogo_productos/MaquinaEmbalaje/2_MÁQUINADEEMBALAJE.webp" alt="Thumbnail 3" onclick="changeMedia(this)" />
                        <img src="../public/images/catalogo_productos/MaquinaEmbalaje/4_PRODUCTO.webp" alt="Thumbnail 4" onclick="changeMedia(this)" />
                        <video src="../public/videos/MÁQUINADEEMBALAJE.mp4" alt="Thumbnail 5" onclick="changeMedia(this)"></video>
                ...
                <div class="product-info">
                    ...
                    <div class="detalles">
                        <div class="detalles-subcont">
                            ...
                            <br>
                            <span>El papel de sellado exterior está controlado por un motor escalonado, la longitud de la bolsa es estable y la posición es precisa. El PLC se utiliza para controlar la acción de toda la máquina, se muestra la interfaz man-machine y el funcionamiento es práctico.</span>
                        </div>
                        <div class="detalles-subcont">
                            <div class="detalles-extra">
                                <b>Modelo:</b> KN-TH169 <br>
                                <b>Potencia:</b> 220V, 50 HZ <br>
                                <b>Capacidad de llenado:</b> 1-5 g/bolsa <br>
                                <b>Flujo de trabajo:</b> 30-50 bolsas/min <br>
                            </div>
                        </div>
                        <div class="detalles-subcont">
                        ...
                        <div class="detalles-subcont">
                            ...
                            <button id="submitButton_maquina__embalaje" class="button" style="display: none;">FINALIZAR</button>
                        </div>
                    </div>
            ...
            <div style="width: 100%; color: #7B7C89;">
                <div id="notification_maquina__embalaje" style="display: none;" class="notification">
                    <p id="notification-text_maquina__embalaje"></p>
    ...
    `;
            ...
            document.getElementById(`submitButton_maquina__embalaje`).addEventListener('click', () => mostrarNotificacion());
        }

        function mostrarNotificacion() {
            const notification = document.getElementById(`notification_maquina__embalaje`);
            const notificationText = document.getElementById(`notification-text_maquina__embalaje`);
        ...
        function openModalForm() {
            ...
            producto.value = "Máquina de embalaje";
        ...
        function enviarButton() {
            ...
            var msg1 = "¡Bienvenid@ a TAMI! ¿Te encuentras lidiando con la tediosa tarea de embalar"+
                " bolsas de té manualmente?¿Has tenido problemas con la pérdida de tiempo y"+
                " dinero debido a errores en el embalaje de tus productos? No te preocupes más,"+
                " con nuestra máquina de embalaje automatizado podrás embalar tus productos de forma"+
                " rápida y precisa en cuestión de minutos. Obtén más detalles en el flyer adjunto. 👀📄";
            var cierre1 ="🤔 Preguntas o Consultas: \n"+
                    "¡Haz que tu negocio destaque con cada producto empaquetado! \n"+
                    "Contáctanos hoy para obtener más información sobre cómo nuestra máquina de"+
                    " embalaje puede mejorar tu proceso de producción y aumentar tu eficiencia 🌟 \n"+
                    ...
                    "Maquina de Embalaje | TAMI (tami-peru.com)";
            var msg2 = "¡Bienvenid@ a TAMI! ¿Sientes que tus bolsitas de té pierden su frescura y aroma"+
                " antes de que puedas disfrutar? Dile adiós a tus problemas con nuestra máquina de"+
                " embalaje, cada bolsita de té se sella al vacío de manera hermética, lo que garantiza"+
                " que el aroma y la frescura del té se conserven desde el preciso momento en que se"+
                " embala. Obtén más detalles en el flyer adjunto. 👀📄";
            var cierre2 = "🤔 Preguntas o Consultas: \n"+
                    "¡Optimiza tu negocio y aumenta tu productividad! \n"+
                    "Contáctanos hoy para obtener más información sobre cómo nuestra máquina de"+
                    " embalaje puede mejorar tu proceso de producción y aumentar tu eficiencia 🌟 \n"+
                    "“Recibe tu asesoría gratis y un descuento exclusivo en las primeras 24h” \n"+
                    "Para más información sobre el producto, ingrese a nuestra página web  👇👇👇 \n"+
