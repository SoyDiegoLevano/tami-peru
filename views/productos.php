    ...
    <main class="main__productos">
        ...
        <section class="productos__catalogo" id="catalogo1">
            ...
            <div style="padding: 10px;">
                <h2 style="color: white;">Emprendimiento</h2>
                <div class="productos__imagenes">
                    <!-- 1 Sellador de Botellas -->
                    <figure class="productos__item" id="S__Botellas"         >
                    <a href="selladorbotellas.php" class="productos__link1">    
                            <img fetchpriority="high" class="productos__img" src="../public/images/catalogo_productos/SELLADORDEBOTELLAS1.webp" alt="SBotellas 1_1" /></a>
                        Sellador de Botellas

                        <figcaption class="productos__description">
                             <a href="selladorbotellas.php">Vista rápida</a>
                        </figcaption>
                    </figure>

                    <!-- 2 Máquina de embalaje-->
                    <figure class="productos__item" id="maquina__embalaje" >
                        <a href="maquinaembalaje.php" class="productos__link1">
                            <img loading="lazy" class="productos__img" src="../public/images/catalogo_productos/MÁQUINADEEMBALAJE1.webp" alt="emabalaje" />
                        </a>
                        Máquina de embalaje
                        <figcaption class="productos__description">
                            <a href="maquinaembalaje.php">Vista rápida</a>
                        </figcaption>
                    </figure>

                    <!-- 3 onclick="openModal('sellador__vasos')"-->
                    <figure class="productos__item" id="sellador__vasos" >
                        <a href="selladorvasos.php" class="productos__link1">
                            <img loading="lazy" class="productos__img" src="../public/images/catalogo_productos/SELLADORDEVASOS1.webp" alt="SELLADOR VASOS" /></a>
                        Sellador de vasos

                        <figcaption class="productos__description">
                            <!--<a href="#productos__tituloCatalogo" class="productos__link2" onclick="openModal('sellador__vasos')">Vista rápida</a>-->
                            <a href="selladorvasos.php">Vista rápida</a>
                        </figcaption>
                    </figure>

                    <!-- 6 onclick="openModal('Selladora-de-bolsas')"-->
                    <figure class="productos__item" id="Selladora-de-bolsas" >
                        <a href="selladorbolsas.php" class="productos__link1">
                            <img loading="lazy" class="productos__img" src="../public/images/catalogo_productos/SELLADORADEBOLSAS1.webp" alt="Selladora-de-bolsas" /></a>
                        Selladora de bolsas

                        <figcaption class="productos__description">
                            <!--<a href="#productos__tituloCatalogo" class="productos__link2" onclick="openModal('Selladora-de-bolsas')">Vista rápida</a>-->
                            <a href="selladorbolsas.php">Vista rápida</a>
                        </figcaption>
                    </figure>
            ...
            <div style="padding: 10px;">
                <h2 style="color: white;">Trabajo</h2>
                <div class="productos__imagenes">




                    <!-- 7 onclick="openModal('Soldadora-LINGBA-5')"-->
                    <figure class="productos__item" id="Soldadora-LINGBA-5" >
                        <a href="soldadoralingba.php" class="productos__link1">
                            <img loading="lazy" class="productos__img" src="../public/images/catalogo_productos/SOLDADORALINGBA1.webp" alt="Soldadora-LINGBA-5" /></a>
                        Soldadora Lingba

                        <figcaption class="productos__description">
                            <!--<a href="#productos__tituloCatalogo" class="productos__link2" onclick="openModal('Soldadora-LINGBA-5')">Vista rápida</a>-->
                            <a href="soldadoralingba.php">Vista rápida</a>
                        </figcaption>
                    </figure>


                    <!-- 8 onclick="openModal('Soldadora-SPARK-3')"-->
                    <figure class="productos__item" id="Soldadora-SPARK-3" >
                        <a href="soldadoraspark.php" class="productos__link1">
                            <img loading="lazy" class="productos__img" src="../public/images/catalogo_productos/SOLDADORASPARK1.webp" alt="Soldadora-SPARK-3" /></a>
                        Soldadora Spark

                        <figcaption class="productos__description">
                            <!--<a href="#productos__tituloCatalogo" class="productos__link2" onclick="openModal('Soldadora-SPARK-3')">Vista rápida</a>-->
                            <a href="soldadoraspark.php">Vista rápida</a>
                        </figcaption>
                    </figure>
            ...
            <div class="grupo1" style="padding: 10px;">
                <h2 style="color: white;">Decoración</h2>
                <div class="swiper">
                <!-- Additional required wrapper -->
                <div class="swiper-wrapper">
                    <!-- Slides -->
                    <div class="swiper-slide">
                        <!-- 4 onclick="openModal('Panel__Fibra')"-->
                        <figure class="productos__item" id="Panel__Fibra" >
                            <a href="panelfibrabamboo.php" class="productos__link1">
                                <img loading="lazy" class="productos__img" src="../public/images/catalogo_productos/BAMBOOFIBERWALLBOARD1.webp" alt="Panel Fibra" /></a>
                                <p style="width: 100%;">Panel de Fibra de Bambo</p>

                            <figcaption class="productos__description">
                                <!--<a href="#productos__tituloCatalogo" class="productos__link2" onclick="openModal('Panel__Fibra')">Vista rápida</a>-->
                                <a href="panelfibrabamboo.php">Vista rápida</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="swiper-slide">
                        <!-- 9 onclick="openModal('Ventilador-Holografico')"-->
                        <figure class="productos__item" id="Ventilador-Holografico" >
                            <a href="ventiladorholografico.php" class="productos__link1">
                                <img loading="lazy" class="productos__img" src="../public/images/catalogo_productos/VENTILADORHOLOGRÁFICO1.webp" alt="Ventilador-Holografico" /></a>
                                <p>Ventilador Holográfico</p>

                            <figcaption class="productos__description">
                                <!--<a href="#productos__tituloCatalogo" class="productos__link2" onclick="openModal('Ventilador-Holografico')">Vista rápida</a>-->
                                <a href="ventiladorholografico.php">Vista rápida</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="swiper-slide">
                        <!-- 10 onclick="openModal('WPC__FENCEPANEL')"-->
                        <figure class="productos__item" id="WPC__FENCEPANEL" >
                            <a href="wpcfencepanel.php" class="productos__link1">
                                <img loading="lazy" class="productos__img" src="../public/images/catalogo_productos/WPCFENCEPANEL1.webp" alt="WPC__FENCEPANEL" /></a>
                                <p>WPC FENCE PANEL</p>

                            <figcaption class="productos__description">
                                <!-- <a href="#productos__tituloCatalogo" class="productos__link2" onclick="openModal('WPC__FENCEPANEL')">Vista rápida</a>-->
                            <a href="wpcfencepanel.php">Vista rápida</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="swiper-slide">
                        <!-- 11 onclick="openModal('WPC__WALLPANEL')"-->
                        <figure class="productos__item" id="WPC__WALLPANEL" >
                            <a href="wpcwallpanel.php" class="productos__link1">
                                <img loading="lazy" class="productos__img" src="../public/images/catalogo_productos/WPCWALLPANEL1.webp" alt="WPC__WALLPANEL" /></a>
                                <p>WPC WALL PANEL</p>

                            <figcaption class="productos__description">
                                <!--<a href="#productos__tituloCatalogo" class="productos__link2" onclick="openModal('WPC__WALLPANEL')">Vista rápida</a>-->
                                <a href="wpcwallpanel.php">Vista rápida</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="swiper-slide">
                        <figure class="productos__item" id="Purificador__deAgua" >
                            <a href="purificadordeagua.php" class="productos__link1">
                                <img loading="lazy" class="productos__img" src="../public/images/catalogo_productos/PRINCIPAL_imagen-purificador-de-agua.webp" alt="Purificador__deAgua" /></a>
                                <p>PURIFICADOR DE AGUA</p>

                            <figcaption class="productos__description">
                                <a href="purificadordeagua.php">Vista rápida</a>
                            </figcaption>
                        </figure>
                    </div>
                </div>
                ...
                <!--<button class="mostrar-grupo2" id="flecha_decoracion">
                <img loading="lazy" class="flecha_decoracion" src="../public/images/catalogo_productos/flecha_decoracion.webp"/>
                </button>
            </div>

            <div class="grupo2" style="padding: 10px; display: none;">
            <h2 style="color: white;">Decoración</h2>
                <div class="productos__imagenes">
                     12 Purificador
                    <figure class="productos__item" id="Purificador__deAgua" >
                ...
                <button class="regresar-grupo1">
                <img loading="lazy" class="flecha_decoracion2" src="../public/images/catalogo_productos/flecha_decoracion.webp"/>
                </button>
            </div>
...
const botonMostrarGrupo2 = document.querySelector('.mostrar-grupo2');
const botonRegresarGrupo1 = document.querySelector('.regresar-grupo1');

// Agregar evento click al botón de mostrar grupo 2
botonMostrarGrupo2.addEventListener('click', function() {
    // Ocultar grupo 1 y mostrar grupo 2
    grupo1.style.display = 'none';
    grupo2.style.display = 'block';
});

// Agregar evento click al botón de regresar al grupo 1
botonRegresarGrupo1.addEventListener('click', function() {
    // Ocultar grupo 2 y mostrar grupo 1
...
//            setUpHeartToggle();
//
//            // Agregar lógica para abrir el formulario después de 20 segundos
//            setTimeout(function() {
//                openModalForm(id);
//           }, 20000);
//       }
...
<script>
    ...
    function initSwiper() {
        if (swiper !== null) {
            swiper.destroy(true, true); // Destruye la instancia de Swiper existente si ya existe
        }
        let slidesPerView;
    ...
    // Llamada inicial para la carga inicial
    ...
    window.addEventListener('resize', function() {
        if (swiper !== null) {
            initSwiper(); // Re-inicializa Swiper con los parámetros actualizados
        }
    });
</script>
