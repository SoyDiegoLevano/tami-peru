...
function enviarButton() {
    ...
    var msg1 = "¿Quieres remodelar tu hogar? Entonces necesitas el PANEL DE FIBRA DE BAMBÚ."+
            "Instalalo con facilidad y disfruta de lo práctico que es en tu hogar."+
            "🏠 Paneles de plástico de molde diseñados para brindar resistencia al agua, facilidad de limpieza y una calidad superior."+ 
            " Eleva el estilo de tu baño de manera práctica y moderna. Transforma tu espacio con la elegancia de Bamboo FIBER Wallboard. 🚿✨";
    var cierre1 = "🤔 Preguntas o Consultas: \n"+ 
            "¡Descubre el poder de la innovación en tu baño con Bamboo FIBER Wallboard! \n"+
            ...
            "https://www.tami-peru.com/views/panelfibrabamboo.php \n"
            "Gracias por tu preferencia 🤗";
    var msg2 = "¡Transforma tu baño en un oasis de tranquilidad con Bamboo FIBER Wallboard!"+
            "🚿✨ Estos paneles de plástico moldeados para baño no solo son impermeables y"+
            "fáciles de limpiar, sino que también aportan un toque de alta calidad y estilo a tu"+
            "espacio. 🌟🛁 ¡Despídete de las preocupaciones  y dale a tu baño el lujo que se"+
            "merece. No te pierdas este producto con 10% de descuento. Renueva tu hogar con"+
            "el PANEL DE FIBRA DE BAMBÚ, te durará toda la vida 🏘️.";
