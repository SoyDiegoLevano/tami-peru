...
<title>Soldadora Spark 3 | TAMI</title>
...
<main class="p_individual">
    <div class="modal-content">
        <div class="product-details">
            <div class="product-images">
                <div class="image-container">
                    <img class="principal-img" src="../public/images/catalogo_productos/SOLDADORASPARK.webp" />
                    <video class="principal-img" src="../public/videos/SOLDADORASPARK.mp4" style="display:none" controls></video>
                </div>
                <div class="product-thumbnails">
                    <img src="../public/images/catalogo_productos/SOLDADORASPARK.webp" alt="Thumbnail 1" onclick="changeMedia(this)"/>
                    <img src="../public/images/catalogo_productos/SoldaraSpark/1imagen.webp" alt="Thumbnail 2" onclick="changeMedia(this)"/>
                    <img src="../public/images/catalogo_productos/SoldaraSpark/2imagen.webp" alt="Thumbnail 3" onclick="changeMedia(this)"/>
                    <img src="../public/images/catalogo_productos/SoldaraSpark/4imagen.webp" alt="Thumbnail 4" onclick="changeMedia(this)"/>
                    <video src="../public/videos/SOLDADORASPARK.mp4" alt="Thumbnail 5" onclick="changeMedia(this)"></video>
                ...
                <div class="detalles">
                    ...
                    <div class="detalles-subcont">
                        <div class="detalles-extra">
                            <b>Modelo:</b> Mig-250 MIG <br>
                            <b>Potencia:</b> 230V, 50/60 HZ <br>
                            <b>Ciclo de trabajo nominal:</b> 60% <br>
                            <b>Peso:</b> 6.5 KG <br>
                            <b>Tipos de Soldadura:</b> MIG MAG/MMA/LIFT TIG 3 en 1 <br>
                        </div>
                    </div>
                    <div class="detalles-subcont">
                    ...
                    <div class="detalles-subcont">
                        ...
                        <button id="submitButton_Soldadora-SPARK-3" class="button" style="display: none;">FINALIZAR</button>
                    </div>
                </div>
        ...
        <div style="width: 100%; color: #7B7C89;">
            <div id="notification_Soldadora-SPARK-3" style="display: none;" class="notification">
                <p id="notification-text_Soldadora-SPARK-3"></p>
...
function generarModalForm() {
    ...
    //                    const notification = document.getElementById(`notification_Soldadora-SPARK-3`);
    //                    const notificationText = document.getElementById(`notification-text_Soldadora-SPARK-3`);
    ...
    //                }
                    ...
                    document.getElementById(`submitButton_Soldadora-SPARK-3`).addEventListener('click', () => mostrarNotificacion());
}
function mostrarNotificacion() {
                        const notification = document.getElementById(`notification_Soldadora-SPARK-3`);
                        const notificationText = document.getElementById(`notification-text_Soldadora-SPARK-3`);
...
function openModalForm() {
    ...
    producto.value = "Soldadora SPARK 3";
...
function enviarButton() {
    ...
    var msg1 = "¿Alguna vez has experimentado frustración al intentar soldar con acabados \n"+
                "profesionales? ¡No te preocupes más! Con la Soldadura Spark, podrás lograr \n"+
                "soldaduras con una precisión milimétrica, lo que garantiza una unión perfecta. \n"+
                "Además, podrás ahorrar costos de electricidad sin tener que sacrificar la calidad de \n"+
                "tus soldaduras. Encuentra más detalles en el flyer adjunto. ¡No te lo pierdas! 👀📄";
    ...
    var cierre1 = "🤔 Preguntas o Consultas: \n"+
                ...
                "Soldadora Spark 3 | TAMI (tami-peru.com)";
    
    var msg2 = "¿Te has sentido frustrado al intentar soldar materiales y obtener resultados poco \n"+
                "satisfactorios? ¡No te preocupes más! Con la Soldadura Spark, podrás trabajar con \n"+
                "una amplia gama de metales y aleaciones, asegurando la máxima compatibilidad \n"+
                "con sus distintas funcionalidades para satisfacer todas tus necesidades de \n"+
                "soldadura. No dudes en consultar el flyer adjunto para obtener más detalles. 👀📄";
