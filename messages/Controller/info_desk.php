...
//require './public/view/libreria/PHPMailer-PHPMailer-2128d99/get_oauth_token.php';
        ...
        "¡DESTACA TU NEGOCIO DIGITAL CON DIGIMEDIA!🙌🏼","¡IMPULSA TU ÉXITO ONLINE CON DIGIMEDIA! 🌐",
        "¡POTENCIA TU NEGOCIO DIGITAL CON DIGIMEDIA!  📈",
        "¡CRECE TU NEGOCIO CON DIGIMEDIA!📈",
        "¡DESTACA TU NEGOCIO DIGITAL CON DIGIMEDIA!🙌🏼", "¡DESTACA TU NEGOCIO DIGITAL CON DIGIMEDIA!🙌🏼",],
        ["¡FORTALECE TU PRESENCIA EN LÍNEA 💻!","¡SUMÉRGETE EN EL MUNDO DIGITAL! 📱","¡INNOVA EN TUS ESTRATEGIAS DIGITALES!",
        "¡MARCA LA DIFERENCIA! 😉", "¡FORTALECE TU PRESENCIA EN LÍNEA 💻!","¡SUMÉRGETE EN EL MUNDO DIGITAL! 📱","¡INNOVA EN TUS ESTRATEGIAS DIGITALES!",
        "¡MARCA LA DIFERENCIA! 😉", "¡MARCA LA DIFERENCIA! 😉"],
        ["¡MAXIMIZA TU PRESENCIA ONLINE! 💻 ","¡AUMENTA TU PRESENCIA EN LAS REDES Y CONQUISTA NUEVAS AUDIENCIAS CON NOSOTROS! 💻🚀",
        "¡Aprovecha los beneficios del mundo digital! 👩🏻‍💻🖥","¡TEN UNA IDENTIDAD ÚNICA! 😉", "¡MAXIMIZA TU PRESENCIA ONLINE! 💻 ","¡AUMENTA TU PRESENCIA EN LAS REDES Y CONQUISTA NUEVAS AUDIENCIAS CON NOSOTROS! 💻🚀",
        "¡Aprovecha los beneficios del mundo digital! 👩🏻‍💻🖥","¡TEN UNA IDENTIDAD ÚNICA! 😉", "¡TEN UNA IDENTIDAD ÚNICA! 😉"]];
