   ...
   /* public function __construct($sub,$em,$me)
    ...
    public static function funcionName($subject,$email, $message){
        ...
        try {
            ...
            $mail->Host       = 'mail.yuntasproducciones.com'; //tipo de servicio o cuenta de hosting                    //Set the SMTP server to send through
            $mail->CharSet = 'utf-8';
            $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
            $mail->Username   = 'pruebayuntas@yuntasproducciones.com';                     //SMTP username
            $mail->Password   = 'Pruebayuntas123';                               //SMTP password
            $mail->SMTPSecure = 'ssl';            //Enable implicit TLS encryption
            $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
            //Recipients
            $mail->setFrom('pruebayuntas@yuntasproducciones.com', 'Yuntas');
